...
urlpatterns = [
    ...
    path('new_insured/', views.new_insured, name='new_insured'),
    ...
    path('insurances/new_insurance', views.new_insurance, name='new_insurance'),
    ...
    path('complete_event/', views.complete_event, name='complete_event'),
